...
{	
	...
	/// </summary>	
	public partial interface IOrderDetailsDAO : IObjectDAO<OrderDetails>, IObjectViewDAO<OrderDetails>
	{
	...
	/// </summary>	
	public partial interface IOrderDetailsViewDAO : IObjectViewDAO<OrderDetailsView>
	{
