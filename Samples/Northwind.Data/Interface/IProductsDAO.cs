...
{	
	...
	/// </summary>	
	public partial interface IProductsDAO : IObjectDAO<Products>, IObjectViewDAO<Products>
	{
	...
	/// </summary>	
	public partial interface IProductsViewDAO : IObjectViewDAO<ProductsView>
	{
