...
<body>
    ...
    <div>
        <asp:DropDownList ID="Fields" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Supplier_PostalCode" HeaderText="Supplier_PostalCode" SortExpression="Supplier_PostalCode" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OldValuesParameterFormatString="original_{0}"
            SelectCountMethod="Count" SelectMethod="Select" SortParameterName="orderBy" TypeName="Northwind.Web.ProductsViewSource">
            <SelectParameters>
